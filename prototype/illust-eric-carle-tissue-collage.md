...
**Avoid (negative prompt)**: vector flat, 3d, smooth digital

## Named references

**Illustrators**: Eric Carle

**Products / films**: The Very Hungry Caterpillar, Brown Bear
...
Kids brands, education products, picture-book aesthetic.

## When NOT to use

B2B, brutalism, polished tech
