...
**Camera / lens**: Pentax 67 medium format, 80mm lens

**Film stock / post-processing**: black and white film, fine medium-format grain, deep tritone print, preserved highlight texture

**Mood**: intimate, dreamy, romantic, unguarded

**Avoid (negative prompt)**: hard flash, studio, posed, retouched, glossy
...
Fragrance campaigns, monochrome editorial, intimate portraiture, anywhere the brief reads as "tender" or "first love" or "skin.

## When NOT to use

Anything needing color, product detail, or commercial-explicit subject.
