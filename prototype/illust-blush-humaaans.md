...
**Avoid (negative prompt)**: 3D, shading, gradient, facial expression
...
**Products / films**: Twilio docs, Mailchimp empty states
...
Inclusive product surfaces, empty states, status pages, where you

## When NOT to use

editorial, brutalism, anything emotive
