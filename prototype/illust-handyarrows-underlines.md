...
role: decoration
pairsPrototypes: [style-doodle, recipe-readcv, aesthetic-corporate-memphis, aesthetic-y2k-memphis-loud]
notForUseWhen: hairline-restraint design systems
---

# HandyArrows — Underlines & Brackets
...
**Avoid (negative prompt)**: solid CSS rule, pixel-perfect
...
Emphasizing words in display headlines, grouping related items.

## When NOT to use

hairline-restraint design systems
