...
role: typography
pairsPrototypes: [aesthetic-vector-neovectorheart, aesthetic-vector-vectorbloom, aesthetic-curly-girly, recipe-warm-restraint]
notForUseWhen: tech, B2B, brutalism
---

# Vectorheart decorative typography
...
**Avoid (negative prompt)**: generic serif, Helvetica
...
Boutique brands, craft-cocktail menus, indie publications.
