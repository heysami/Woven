...
**Camera / lens**: Canon 5D with 28mm or 35mm prime

**Film stock / post-processing**: saturated journalism color, slight grain, gritty texture, slight motion blur

**Mood**: grave, witness, present

**Avoid (negative prompt)**: staged, glossy, posed, retouched, beautiful
...
Editorial only — news, documentary film stills, NGO campaign. NEVER for consumer brand work.

## When NOT to use

Any commercial application. Reserved for editorial truth.
