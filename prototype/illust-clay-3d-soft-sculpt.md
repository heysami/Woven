...
**Avoid (negative prompt)**: glossy plastic, chrome, hairline, photoreal skin
...
**Products / films**: Apple AirPods 3D claymation ads
...
Style-claymorphism interfaces, warm-restraint marketing, premium

## When NOT to use

cyberpunk, brutalism, neon
