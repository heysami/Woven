...
category: conceptual
era: current
pairsPrototypes: [aesthetic-y2k-memphis-loud, aesthetic-wacky-pomo, style-bold-display, aesthetic-acid-graphics]
notForUseWhen: Anything sincere, B2B, wellness, heritage.
---

# Surreal still-life conceptual
...
**Camera / lens**: Phase One IQ4, 100mm macro, f/8

**Film stock / post-processing**: single-hue palette, oversaturated, dust-clean retouch

**Mood**: surreal, ironic, witty

**Avoid (negative prompt)**: natural light, candid, soft, busy backdrop
...
High-concept beauty, snack and beverage editorial, conceptual e-comm hero, gallery and magazine, ironic premium.

## When NOT to use

Anything sincere, B2B, wellness, heritage.
