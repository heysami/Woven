...
role: subject
pairsPrototypes: [aesthetic-corporate-memphis, recipe-bento-marketing, recipe-warm-restraint, aesthetic-coastal-grandmother]
...
**Avoid (negative prompt)**: bright saturated, pattern-heavy
...
Blog headers, content marketing for lifestyle / wellness SaaS.

## When NOT to use

youth-music brands, brutalism
