...
**Avoid (negative prompt)**: photoreal space, 3d render, neon cyber
...
**Products / films**: Saul Bass-adjacent, Atompunk
...
When you want retro-cool, atompunk, or playful tech without going Y2K.

## When NOT to use

photoreal, dense data UI
