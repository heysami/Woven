...
images:
  - src: aesthetic-y2k-myspace-ui.png
...
- Glittery animated GIFs (deliberately low frame-count, janky loops)
- Pixelated heart icons, neon star-bursts, low-poly sparkles
- Lowrez webcam-selfie cutouts with hard JPEG artifacts
- MSN / AIM emoticon raster stickers
- Sharpie-on-notebook-paper scribbles, doodle hearts and arrows
- Butterfly clip-art PNGs, Lisa-Frank rainbow stickers
- Custom MySpace-layout glitter banners (cursive bubble-letters)
- Denim, rhinestone, and fabric-scrap textures
- AIM buddy-icon 100x100 hard-pixel squares
- Substrate: lined notebook page or dark denim
- Type: handwritten Sharpie scrawl + GIF-rendered bubble-letters

## Voice register

Lowercase, abbreviations from the era ("omg", "<3", "bff", "xoxo"), inside-jokes in song lyric form, friend names dropped without context, ALL CAPS for emphasis. Never corporate, never explanatory. Read like a private journal that you also want everyone to see.
...
- Personal sites, "about me" pages, fan profiles, music-discovery / mixtape sharing
- Teen / young-adult audiences, nostalgia plays for millennials born 1988-1997
- Subjects: friendship, music fandom, diary-keeping, identity construction, crush culture
- Anti-corporate, anti-minimal, performatively unprofessional contexts
