...
# Illuminated drop cap (medieval revival)
...
**Avoid (negative prompt)**: modern sans, geometric, vector flat
...
Long-form editorial, literary site, book-cover design.

## When NOT to use

tech, brutalism, anything sans-serif
