...
**Camera / lens**: Pentax K1000, 50mm f/1.4

**Film stock / post-processing**: Kodachrome 64, amber and earth tones, soft halation, warm grain

**Mood**: dreamy, romantic, free

**Avoid (negative prompt)**: studio, hard flash, cool, modern, sharp
...
Heritage fashion, nostalgia campaigns, wellness for older demographics, hospitality summer marketing.

## When NOT to use

Tech, B2B, modern minimal.
