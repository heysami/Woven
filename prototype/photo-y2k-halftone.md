...
**Camera / lens**: any digital source, transformed in post

**Film stock / post-processing**: coarse halftone screen, slight ink registration shift, paper texture, slight yellow paper tone

**Mood**: zine, raw, kinetic

**Avoid (negative prompt)**: smooth gradient, photoreal skin, perfect print, clean
...
Music posters, zine, streetwear lookbook, Gen-Z marketing, hero images for editorial websites that want to reference print culture.

## When NOT to use

Luxury, premium, anything aspirational-clean.
