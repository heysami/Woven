...
---
# DORFic (industrial Frutiger) (aesthetic)
...
- DORFic Frutiger Aero Wiki spec — the codified "industrial pole" sibling of Frutiger Aero
...
Second tell: warm autumn orange used like a Frutiger Aero amber accent on a sky-blue page (DORFic orange detonates against grey-white concrete, never sky).

Third tell: anti-aliased SVG "low-poly" triangles with soft 24px shadows and oklch gradient fills, when real DORFic low-poly is hard-edged flat-shaded facets.

Fourth: humanist Frutiger/Segoe used as the only face (the parent family's voice) instead of swapping the header to a geometric-industrial Eurostile/DIN/Bank Gothic.

Fifth: any bubble, dolphin, grass blade, or aurora — these collapse DORFic back into its Frutiger Aero parent and break the industrial pole.
