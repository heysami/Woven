...
role: decoration
pairsPrototypes: [style-doodle, aesthetic-corporate-memphis, recipe-bento-marketing, recipe-readcv]
notForUseWhen: dense data UI, brutalism
---

# HandyArrows — Hand-drawn Arrows (185+)
...
**Avoid (negative prompt)**: 3d arrow, polished icon, photoreal
...
Pointing at headlines, marking flow steps, illustrating "click here.

## When NOT to use

dense data UI, brutalism
