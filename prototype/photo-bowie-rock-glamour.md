...
**Camera / lens**: Hasselblad 500CM, 80mm

**Film stock / post-processing**: Kodak Ektachrome saturated, slight haze diffusion, retained costume detail

**Mood**: theatrical, defiant, iconic

**Avoid (negative prompt)**: candid, natural light, restrained
...
Music marketing, concert posters, fashion editorial for music-adjacent brands, retro nostalgia.

## When NOT to use

Restrained luxury, B2B, wellness.
