...
**Camera / lens**: Hasselblad H6D, 100mm macro, f/5.6

**Film stock / post-processing**: muted earth palette, no saturation, gentle film grain overlay

**Mood**: calm, considered, apothecary

**Avoid (negative prompt)**: bright, saturated, plastic, glossy, busy backdrop
...
Skincare, fragrance, premium personal care, slow-luxury packaging, hospitality amenity kits.

## When NOT to use

Mass-market product, anything loud, family CPG.
