...
category: lifestyle
era: 2011-current
pairsPrototypes: [recipe-warm-restraint, style-cream-humanist, aesthetic-cottagecore, aesthetic-coastal-grandmother]
notForUseWhen: Tech, fast e-comm, B2B, edgy fashion.
---

# Kinfolk warm minimal editorial
...
**Camera / lens**: Canon 5D, 50mm at f/2.8

**Film stock / post-processing**: warm beige palette, slightly faded, soft contrast

**Mood**: slow, warm, considered

**Avoid (negative prompt)**: saturated, hard light, kinetic, urban grit
...
Wellness, slow lifestyle, hospitality, home goods, tea and coffee brands, parenting for older demos.

## When NOT to use

Tech, fast e-comm, B2B, edgy fashion.
