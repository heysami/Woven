...
**Camera / lens**: Canon 5D, 50mm at f/8, color filter overlay

**Film stock / post-processing**: pastel pink-cyan grade, slight chromatic aberration, VHS scanline overlay, soft gradient

**Mood**: dreamy, ironic, nostalgic-future

**Avoid (negative prompt)**: natural light, warm grade, photojournalism
...
Music streaming art, ironic-nostalgic brand campaigns, indie game key art, club night posters.

## When NOT to use

Heritage, wellness, premium consumer.
