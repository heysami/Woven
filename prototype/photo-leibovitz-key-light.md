...
**Camera / lens**: Hasselblad medium format, 80mm or 50mm equivalent

**Film stock / post-processing**: rich color, retained ambient warmth, painterly tonality

**Mood**: theatrical, thoughtful, deliberate

**Avoid (negative prompt)**: snapshot, candid, available light only, harsh flash, club
...
Founder portraits, About Us photography, magazine-style profile shots, conference speaker headshots that need to feel cinematic. The default for "tell their story" briefs.

## When NOT to use

Quick product, e-comm hero, anything needing many subjects in one shot.
