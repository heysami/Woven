---
styleId: pixar-inside-out-emotion-volumetric
name: Pixar Inside Out emotion-volumetric
category: 3D
...
**Primary**: Inside Out Pixar emotion character, volumetric particle aura, body surface beneath glow, color-coded emotion

**Material**: 3D body surface wrapped in **volumetric particle aura that radiates outward**, boiling-effect surface shimmer, **subsurface scatter** through the volume, glowing (Joy) or solid (Anger) per emotion
...
**Avoid (negative prompt)**: solid-flat character (must have volumetric aura), photoreal skin, no-particles, multiple emotion colors blended

## Named references

**Studios / films**: Pixar Animation Studios; *Inside Out* (2015), *Inside Out 2* (2024); director Pete Docter; production designer Ralph Eggleston
...
> Pixar-grade 3D character illustration of an **emotion personified**
...
> with large expressive eyes and small bodies. Soft directional studio
> lighting. Optional: **glass memory orbs** in the same emotion color
> stored on infinite shelves stretching to vanishing point in the background.
> Pixar *Inside Out* (Pete Docter / Ralph Eggleston) emotion-volumetric
> aesthetic.

## When to use

Mental-health / mindfulness app branding, therapy / wellness / journaling product launches, parenting / family-content sites, kids-and-emotions educational products, charity / non-profit emotional-narrative campaigns, mental-wellness brand mascot work, emotion-tracking / mood-journaling apps.

## When NOT to use

brutalism, cyberpunk, restrained-editorial, B2B-clean, photoreal product marketing
