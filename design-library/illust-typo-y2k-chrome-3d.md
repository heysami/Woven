...
**Avoid (negative prompt)**: matte, flat, hand-drawn, paper texture
...
**Products / films**: Rosalia MOTOMAMI lettering, Bad Bunny album art
...
Y2K revival branding, music marketing, beauty drops, Gen-Z fashion.

## When NOT to use

editorial restraint, B2B, Bauhaus
