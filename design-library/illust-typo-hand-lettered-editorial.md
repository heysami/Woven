...
**Avoid (negative prompt)**: generic font, sloppy, anti-design
...
Premium editorial, book covers, magazine titles, restaurant identity.

## When NOT to use

brutalism, sans-only design system
