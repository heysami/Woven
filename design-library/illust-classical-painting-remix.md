---
styleId: classical-painting-remix
name: Classical painting remix
...
**Primary**: renaissance oil painting of figures with modern [product], baroque campaign illustration, old master remix
...
**Style**: classical genre painting hosting one anachronism

**Avoid (negative prompt)**: digital airbrush smoothness, fantasy art, photo collage seams, cartoon proportions, multiple anachronisms
...
Fashion/luxury campaigns with wit, editorial covers about tech-meets-tradition, heritage brands launching digital products, dark-academia and maximalist registers needing figurative heroes.

## When NOT to use

Engineering-credibility briefs, minimal product UI marketing, anything where irony would be missed.
