---
styleId: 3d-dreamscape-terrain
name: 3D dreamscape terrain
category: 3D
...
**Primary**: soft 3D landscape render, rolling velvet hills, dreamy pastoral terrain, idealized environment
...
**Style**: stylized environment render, Bliss-wallpaper sincerity in modern 3D

**Avoid (negative prompt)**: photoreal grass blades, rocky badlands, dark moody weather, game-HUD elements, harsh shadows

## Named references

**Illustrators**: modern Blender environment school (clean stylized terrain), Logoisum-style dreamscape hero renders, Alto's Adventure / Sky: Children of the Light environment language

**Movements**: calm-tech landscape renders, wallpaper-revival sincerity
...
Pastoral-serene SaaS heroes wanting a rendered (not photographic) ground, scroll-journey terrains, onboarding worlds, video-agency dreamscape openers, calm-tech empty states.

## When NOT to use

Hard-tech/industrial briefs, documentary registers, dark-mode-first products.
