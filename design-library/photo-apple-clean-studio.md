...
**Camera / lens**: Phase One IQ4, 80mm macro, f/11 for product sharpness

**Film stock / post-processing**: color-managed digital, no grain, controlled gradient, retouched dust-clean

**Mood**: precise, premium, certain

**Avoid (negative prompt)**: grain, vignette, prop clutter, lifestyle context, hand holding
...
Hardware product, consumer electronics hero, e-commerce premium product page, app store icons-from-photo.

## When NOT to use

Lifestyle storytelling, editorial, anything needing context or mood.
