...
**Avoid (negative prompt)**: opaque matte, metallic, realistic skin, sharp angular
...
**Products / films**: Haribo gummy aesthetics, fintech onboarding mascots circa 2023
...
When a marketing surface needs an empty-headed friendly mascot that

## When NOT to use

dense Bloomberg-style data UI, brutalist or editorial layouts
