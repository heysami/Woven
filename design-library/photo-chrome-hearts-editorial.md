...
**Camera / lens**: point-and-shoot digital, 35mm equivalent

**Film stock / post-processing**: slight color noise in shadows, warm highlight bloom, crushed black point

**Mood**: decadent, insomniac, casually wealthy

**Avoid (negative prompt)**: clean studio, daylight, smiling, group shot, wide landscape
...
Streetwear drops, jewelry campaigns, fragrance for younger demos, club-luxe lookbooks, fashion editorial for brands that want to read as 2025-cool without being too referential.

## When NOT to use

Family product, B2B, anything wholesome.
