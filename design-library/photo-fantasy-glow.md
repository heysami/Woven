...
**Camera / lens**: Arri Alexa, 50mm or 85mm with cinematic glow filter

**Film stock / post-processing**: warm cinematic grade, emerald saturation, gentle halation, slight grain

**Mood**: magical, reverent, dreamlike

**Avoid (negative prompt)**: flash, hard noon sun, urban, modern
...
Game marketing, fantasy publishing, premium fragrance with mythological angle, theme park, niche perfume.

## When NOT to use

B2B, modern minimal, tech product.
