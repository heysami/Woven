---
styleId: papercraft-diorama-world
name: Papercraft diorama world
category: 3D
...
**Primary**: papercraft diorama scene, cut paper world, layered cardstock landscape, handmade paper village
...
**Style**: handcrafted diorama photographed like a miniature set

**Avoid (negative prompt)**: smooth plastic 3D, perfect machine precision, photoreal materials, flat vector pretending to be paper, dark moody light
...
> A papercraft diorama world photographed like a miniature set: layered cardstock hills in three pastel greens stepping back in visible strata, a small folded-paper cottage with tab-and-slot walls and a curling smoke spiral of white quilling paper, scalloped blue card waves along the foreground edge, and three slightly crooked paper pine trees. Soft warm key light casts true occlusion shadows between the paper layers; cut edges and fold scores stay visible. Construction-paper saturation, fibrous texture, handmade charm. Wide composition that could extend into a scrolling world.
...
Premium-minimal hardware, fintech gravitas, photoreal-documentary briefs. For a single elegant paper SUBJECT (one crane, one flower), use `origami-paper-3d` instead.

## Pairs with (prototype slugs)

- `aesthetic-positivity-kawaii`
- `aesthetic-cottagecore`
- `shell-infinite-canvas`
