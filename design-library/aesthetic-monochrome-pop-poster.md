...
**Palette anchor (pick ONE per project):** signal orange `#ff4d00`, cobalt `#0a36ff`, acid yellow `#ffd400`, coral `#ff5a64`, racing red `#e8231a`. Plus ink (black or white, whichever survives), and at most a 10%-darker shade of the hue for depth. NO second hue anywhere.
...
Drop-culture imperatives, 2-4 words: "NEW ERA." "FULL POWER." "OWN THE GAME." All-caps is the grammar. Numbers as flex ("+65K", "VOL. 03"). Never paragraphs in the hero.

## Failure mode

Three hues sharing the flood, a soft pastel wash instead of full saturation, polite title-case headlines, the object centered timidly at 40% scale = sale-banner, not drop-poster. Commit: full-bleed hue, oversized object, edge-cropped type.

## Best for

Product drops and launches (sneakers, hardware, automotive), sports and gaming brands, event/festival promos, bold portfolio heroes, ecommerce category takeovers.

## Pairs well with

- **Shells:** `shell-hero-stack` (poster mode), `shell-top-bar-canvas` (commerce), `shell-horizontal-scroll-stage` (drop-per-panel reels).
- **Styles:** `style-bold-display`, `style-oversized-neo-grotesque`, `style-neubrutalism` (for harder borders/shadows).
- **Aesthetic kin:** `aesthetic-y2k-memphis-loud` (plural-color cousin), `aesthetic-urbling` (bling cousin).
- **Photo:** `dark-product-stage`, `motorsport-dramatic` (duotone-tinted into the flood).
