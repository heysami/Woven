...
**Camera / lens**: Canon R5, 100mm macro at f/8

**Film stock / post-processing**: pure even white, retained skin texture, slight color saturation push on lips

**Mood**: graphic, clean, iconic

**Avoid (negative prompt)**: moody, shadow, environment, candid
...
Cosmetics e-comm hero, beauty product launch, fragrance for modern minimal brands.

## When NOT to use

Editorial mood, lifestyle, anything narrative.
