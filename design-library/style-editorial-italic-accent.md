...
- Host sans: Inter / Geist / Söhne / Neue Haas Grotesk, 500-600
- Accent serif, pick by register:
  - **Refined**: Canela, GT Sectra Fine, Freight Display Italic
  - **Classic**: Times Ten Italic, Playfair Display Italic
  - **Sharp/luxe**: Italiana, Cormorant Italic (light weights at display sizes only)
- Accent weight reads ONE step lighter than the sans (e.g. sans 600 + serif 500 italic)
...
- Display 48-88px; the move dies below ~32px (body-size italic serif just looks like emphasis)
- Subheads may echo with a smaller italic-serif lead-in word, max once per section
