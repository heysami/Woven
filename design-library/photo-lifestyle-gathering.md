...
**Primary**: golden hour lakeside gathering, friends at a long outdoor table, candid group documentary, community picnic

**Lighting**: low golden sun backlighting the group, warm bounce, string lights at dusk variant

**Camera / lens**: 35mm at f/4 from 10-20m back, level, unposed moment

**Film stock / post-processing**: Portra 400 warmth, gentle contrast, true skin tones, no Instagram teal

**Mood**: belonging, ease, unhurried abundance

**Avoid (negative prompt)**: posed group smiles at camera, corporate team-building energy, studio light, oversaturated sunset, stock-photo cleanliness

## Named references

**Photographers**: Wolfgang Tillmans' communal candids (tamer), Kinfolk gathering features, William Eggleston's democratic eye for the setting

**Campaigns**: ClubX "Finance. Freedom. Fellows." lakeside crowd; Airbnb Experiences documentary work
...
Community-positioned fintech/membership brands ("Finance. Freedom. Fellows."), hospitality and venues, neighborhood/social apps, employer-brand pages that want warmth without posed-team fakeness, pastoral-serene briefs needing PEOPLE.

## When NOT to use

Solo-focus productivity tools, luxury-exclusive registers (the crowd democratizes), clinical trust pages.
