...
**Avoid (negative prompt)**: polished, vector perfect, AI-render, color fill
...
**Products / films**: The Luttrell Psalter, Smith of Wootton Major
...
Editorial blogs that want to signal human craft over AI slop;

## When NOT to use

SaaS marketing, cute-friendly contexts, 3D contexts
