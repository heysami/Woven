---
styleId: retro-contraption-3d
name: Retro contraption 3D
category: 3D
...
**Primary**: whimsical retro machine render, invented contraption with knobs and tubes, charming vintage computer hybrid
...
**Style**: stop-motion-adjacent product render, Aardman-meets-Teenage-Engineering charm

**Avoid (negative prompt)**: sleek modern industrial design, dark cyber styling, photoreal grime, sharp edges, exposed gore-tech wiring

## Named references

**Illustrators**: Nickel Payments' payment-machine hero (the corpus case), Teenage Engineering product language (the real-world cousin), Wallace & Gromit invention lineage, Pixar-short appliance characters

**Movements**: cassette-futurism (friendly branch), dev-tool mascot-machine marketing
...
Fintech/dev-tool briefs that want approachable-not-corporate ("unlock growth with every payment"), product metaphors (the API as a machine), empty states and onboarding, cassette-futurism briefs needing a hero object.

## When NOT to use

Premium-sleek hardware, enterprise gravitas, anything where "toy-like" undermines trust.
