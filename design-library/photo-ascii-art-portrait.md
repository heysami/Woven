...
**Primary**: ASCII art portrait, text-as-image, monospace character mosaic, CRT terminal aesthetic, hacker-BBS look
...
**Mood**: hacker, terminal, retro-tech, BBS-era, dev-tools, computational

**Avoid (negative prompt)**: smooth gradient, proportional font, full-color photographic, antialiased, low-contrast original

## Named references

**Tools**: manytools.org ASCII generator, asciiart.club, image2ascii libraries, jp2a (Linux), Codeshack ASCII converter

**Era / movement references**: 1990s BBS culture (ANSI art), CRT terminal aesthetics, hacker-zine traditions (2600 magazine), modern dev-tools marketing using ASCII (Vercel CLI splash, Bun install ASCII, GitHub Octocat ASCII)

**Modern revival**: dev-tools README ASCII headers, terminal-aesthetic landing pages, CLI tool branding (Charm.sh products), Are.na ASCII channels
...
Dev-tools marketing, CLI-tool branding, terminal-on-web hero images, hacker / cybersecurity editorial, retro-BBS revival, programmer-culture content, README headers.

## When NOT to use

warm-lifestyle, premium-luxury, photoreal product, anything wanting smooth modern feel
