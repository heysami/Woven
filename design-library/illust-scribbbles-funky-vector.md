...
**Avoid (negative prompt)**: filled shape, character, scene
...
**Products / films**: Notion-era hand-drawn marketing accents
...
Background accent, replacing solid divider lines, highlighting

## When NOT to use

editorial, brutalism, photoreal
