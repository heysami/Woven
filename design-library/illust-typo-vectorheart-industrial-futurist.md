---
styleId: typo-vectorheart-industrial-futurist
name: Vectorheart industrial-futurist (Designers Republic / Wipeout)
...
**Primary**: vectorheart, Designers Republic, Wipeout UI, industrial-futurist typography, vector geometric

**Material**: vector flat, high-contrast, hairline + solid

**Line**: 45° / 60° diagonal hairlines, ticks, registration marks

**Color**: black + neon-green / orange / cyan / hazard-yellow + white

**Style**: Swiss-grid + brutalist twist, micro-iconography, version-string accents

**Avoid (negative prompt)**: heart-shapes, romantic, warm pastels, hand-drawn, blackletter, decorative ornament, organic curves
...
**Products / films**: Wipeout / Wipeout 2097 / Wipeout 3 PSX game UI (canonical Designers Republic work), Pop Will Eat Itself sleeve work, Warp Records 1990s identity
...
> flat with no gradients, vectorheart industrial-futurist 1990s aesthetic.

## When to use

AI-product marketing wanting industrial-futurist edge, dev-tools, gamer-culture brands, electronic music, sci-fi game UI, neo-y2k revival, brutalist editorial.

## When NOT to use

cottagecore, romantic craft, warm-paper editorial, anything wanting heart-shapes or ornament

## Pairs with (prototype slugs)

- `aesthetic-vector-neovectorheart`
- `aesthetic-vector-vectorbloom`
- `aesthetic-cyberpunk`
