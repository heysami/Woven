...
**Camera / lens**: Hasselblad medium format, 80mm, f/8

**Film stock / post-processing**: single-hue saturation, painterly highlight, retained shadow detail

**Mood**: contemplative, surreal, deliberate

**Avoid (negative prompt)**: candid, snapshot, journalism, busy composition
...
High-concept editorial, luxury fashion campaign, perfume, niche book covers, gallery print.

## When NOT to use

Mass-market product, B2B SaaS, anything quick-to-decode.
