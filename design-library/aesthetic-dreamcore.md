...
images:
  - src: aesthetic-dreamcore-ui.png
    reason: Aesthetic vocabulary in UI.
  - src: aesthetic-dreamcore-isolated.png
...
- Dim-yellow `#E8D89A` (fluorescent-bulb hallway)
- Sick-pink `#D8A2B0` (faded birthday-party streamer)
- Carpet-teal `#5A7872` (90s patterned office carpet)
- Hallway-beige `#BCB294` (drywall under bad light)
- Photocopy-grey `#8B8B82` (the sixth-generation copy)

No saturated colors. No pure black. No pure white. Everything is one bleach-cycle away from gone.

## Decoration motifs

- Liminal-space photographs: empty indoor pools, deserted school hallways at dusk, lone playgrounds, abandoned mall food courts, fluorescent-lit stairwells
- VHS-degraded family-photo stills with date-stamps in the corner
- Photocopied-many-times faces (identity slowly erasing)
- Smudged-pencil hand-drawn smile glyphs on lined paper
- Kid-drawn marker scribbles, deliberately childish, deliberately wrong
- Half-melted plastic-toy PNGs
- AOL-era loading-screen sprites, dial-up progress bars frozen mid-load
- Clouds with deliberately-wrong colors (pink sky, green clouds)
- Fading polaroid edges, slight tape residue
- Occasional all-caps photocopied warning labels ("DO NOT", "EXIT", "PLEASE WAIT") with no referent

## Voice register

- Microcopy reads like a half-remembered note in a child's handwriting
- Lowercase, often missing punctuation, occasionally a word misspelled the way a six-year-old would misspell it
- Sparse all-caps interjections that feel found, not designed ("DO NOT RUN", "ARE YOU STILL THERE")
- Avoid corporate cheer, avoid product-voice, avoid emoji
- The interface should sound like it is remembering you, not addressing you
