---
styleId: face-id-dot-projector
name: Face-ID dot-projector / structured-light depth scan
category: conceptual
era: current
...
**Mood**: clinical, surveillance, biometric, sci-fi-near-future, identification-moment

**Avoid (negative prompt)**: warm light, natural environment, gentle, ambient room light, soft fill

## Named references

**Tech reference**: Apple TrueDepth / Face ID (iPhone X 2017 onward), Microsoft Kinect structured-light depth, Intel RealSense, LiDAR depth-scan visualizations

**Art / editorial references**: Trevor Paglen surveillance-aesthetics work, Hito Steyerl identity-and-image, Wired magazine biometric-themed features, MIT Tech Review AI-identity covers

**Movements**: post-2017 surveillance-aesthetics, AI-identity art, biometric editorial
...
> identification-moment mood. Structured-light depth-scan photography
> aesthetic.

## When to use

AI / biotech editorial, identity/surveillance commentary, cybersecurity marketing, near-future fiction, gallery / fine-art conceptual, dark-academia tech-criticism, AI-product hero shots with gravitas.

## When NOT to use

warm-lifestyle, cottagecore, kids brands, restrained editorial, friendly-tech
