...
**Camera / lens**: Canon 5D, 100mm macro at f/2.8

**Film stock / post-processing**: oversaturated cheerful color, glossy specular, slight HDR, blown sky

**Mood**: optimistic, sky-fresh, 2007-internet

**Avoid (negative prompt)**: moody, dark, gritty, monochrome, restrained
...
Consumer-electronics retro campaigns, Y2K-aesthetic stock, sky-positive product marketing, nostalgia plays.

## When NOT to use

Luxury, restrained, premium B2B.
