...
**Film stock / post-processing**: glitch art treatment, datamoshing, channel shift, scanline overlay, posterized color

**Mood**: aggressive, broken, kinetic

**Avoid (negative prompt)**: clean, smooth, calm, restrained
...
Music streaming art, electronic music posters, cyberpunk-themed game key art, edgy fashion, indie experimental editorial.

## When NOT to use

Premium, B2B, anything restrained or sincere.
