...
**Camera / lens**: Nikon F2 with on-camera flash, 35mm lens

**Film stock / post-processing**: Kodachrome 64 or Ektachrome, saturated reds and ambers, slight grain

**Mood**: intimate, vulnerable, honest, lived

**Avoid (negative prompt)**: studio, retouched, posed, glamour, professional model
...
Indie fashion, LGBTQ-targeted campaigns, music for indie scenes, AIDS-history editorial, intimate documentary content.

## When NOT to use

Family-friendly product, B2B, anything wholesome.
