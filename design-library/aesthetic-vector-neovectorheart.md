...
- 45° chamfered cuts (never rounded, never free-angle)
- Filled discs and rings
...
- Glitch filters, chromatic aberration, RGB-split
- Hexagon backgrounds, circuit-board patterns, Y2K bubble chrome
- Kanji used as decorative texture (parent Vectorheart could; Neo cannot)
- Round corners, free rotations off the 45/60 grid
- Orbitron, Audiowide, Blade Runner, Press Start typefaces

## Voice register

Terse, declarative, all-caps spec-sheet. Military / regulation / catalog. No marketing prose, no exclamations, no friendly second person. Examples: `AGENT 014 · REGION NA · TACTICAL`, `ISSUE 022 / 2026-06-08`, `CALIBER 9MM · LOT 0317`. Wide tracking on caps is mandatory; the meta-line is the texture.

## Failure mode

The generic "cyberpunk gamer poster": Orbitron wordmark + cyan/magenta gradient + glitch filter + hex pattern + circuit board = synthwave cosplay, not Neo-Vectorheart. The AI tell is multi-hue gradients, round corners, any angle that isn't 45 or 60, and kanji-as-texture. If it looks like a Twitch overlay, it has failed; Neo-Vectorheart looks like a regulation document for a product that doesn't exist yet.

## Best for

- Esports and competitive-game brand pages (VALORANT-adjacent)
- Tactical hardware drops, knife/EDC/firearm-adjacent product pages
- Streetwear and sneaker collaboration lookbooks
- Racing, motorsport, and automotive launch sites
- Indie-game splash sites with a competitive register
- Editorial pages for fashion-meets-sport crossover collections

## Pairs well with

- **Shells**: shell-hero-stack, shell-editorial-broken-grid, shell-bento-grid, shell-canvas-floating, shell-centered-column, shell-top-bar-canvas
- **Styles**: style-oversized-neo-grotesque, style-brutalist-raw, style-restrained-hairline, style-dense-mono-dark, style-bold-display
