---
styleId: 3d-technical-exploded-precision
name: Technical exploded-view precision 3D
category: 3D
...
**Avoid (negative prompt)**: lifestyle context, environmental clutter, multiple light sources, painterly, hand-drawn, glowing accents (that's Tron-emissive), cute

## Named references

**Studios**: NotTriangle Studio, Max Kulich (maxkulich.com), 360 Render, 7CGI, Freedes Studio

**Brand reference**: Apple keynote product-internals reveal slides, Tesla Battery Day exploded battery, Framework Laptop internals marketing, Fairphone repairability reveal, Ledger / Trezor hardware-internals, Polar / Garmin sensor breakdowns

**Movements**: technical-illustration 3D revival, repairability-marketing aesthetic, hardware-startup launch-day visualization, "Right-to-Repair" iconography
...
> depth-readable. Clean grey backdrop, sharp directional studio shadow
> from upper-left, accurate engineering materials (anodised, PCB green,
> matte plastic). Precision-engineering / "look how it's built" technical
> illustration aesthetic.

## When to use

Hardware-startup product launches, dev-tools / scientific-infra marketing, B2B-tech engineering credibility, "how it works" sections, repairability / Right-to-Repair marketing, sensor / wearable / fintech-hardware reveals.

## When NOT to use

cottagecore, kids brands, warm-lifestyle, positivity-kawaii, anything wanting friendly-cuddly register
