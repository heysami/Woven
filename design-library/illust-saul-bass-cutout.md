...
**Avoid (negative prompt)**: photoreal, soft, gradient

## Named references

**Illustrators**: Saul Bass

**Products / films**: Anatomy of a Murder, Vertigo, Man with the Golden Arm
...
Editorial hero, premium film/event marketing, museum-quality identity.

## When NOT to use

friendly SaaS, brutalism, cottagecore
