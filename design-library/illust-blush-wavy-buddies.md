...
**Avoid (negative prompt)**: straight line, 3d, photoreal
...
**Products / films**: Shopify partner marketing
...
Ecommerce empty states, lifestyle content, content blog headers

## When NOT to use

B2B serious, brutalism, financial dashboards
