...
**Camera / lens**: Canon EOS R6, 28mm or 35mm lens

**Film stock / post-processing**: CineStill 800T halation, saturated cyan-magenta, sharp focus on eyes, crushed black

**Mood**: confident, nocturnal, magnetic

**Avoid (negative prompt)**: smiling group, daylight, soft lighting, pastel
...
Streetwear campaigns, music streaming app art, neon-themed editorial, club marketing, anything that wants to read as 2 a.m.

## When NOT to use

Daylight product, family, wellness.
