...
**Avoid (negative prompt)**: chibi, kawaii, flat

## Named references

**Illustrators**: Makoto Shinkai, CoMix Wave Films

**Products / films**: Your Name, Weathering with You, Suzume
...
Premium anime-influenced product marketing, lifestyle storytelling.

## When NOT to use

B2B serious, brutalism
