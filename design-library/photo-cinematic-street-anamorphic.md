...
**Camera / lens**: Arri Alexa, anamorphic 50mm, oval bokeh, horizontal blue flares

**Film stock / post-processing**: teal-and-orange grade, gentle film grain overlay, slight halation

**Mood**: contemplative, melancholy, observed

**Avoid (negative prompt)**: bright, daylight, smiling, posed portrait, flat lighting
...
Hero video stills, premium tech ads, fragrance, automotive, anything that needs to read as "film" not "photo.

## When NOT to use

Anything bright, daylight-driven, product e-comm.
