---
styleId: ink-wash-atmosphere
name: Ink-wash atmosphere field
...
**Primary**: sumi-e ink wash clouds, monochrome atmospheric painting, billowing ink masses on paper, tonal wash field
...
**Style**: contemporary sumi-e abstraction, atmosphere over object

**Avoid (negative prompt)**: color, hard vector edges, recognizable objects, digital gradient smoothness, busy splatter everywhere

## Named references

**Illustrators**: Celestia's "Superintelligence on-device" ink-sky hero (the corpus case), Gao Xingjian's ink atmospheres, traditional sumi-e cloud studies, Hiroshi Senju's waterfall tonality

**Movements**: contemporary ink-wash abstraction, East Asian brush tradition in editorial use
...
Dark-academia and contemplative-AI heroes ("superintelligence, quietly"), editorial section grounds, monochrome-tech-editorial softening, meditation/philosophy brands, anywhere a photograph would be too literal.

## When NOT to use

Bright consumer pop, data-dense dashboards, briefs needing depicted subjects.
