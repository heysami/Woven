...
**Avoid (negative prompt)**: friendly, pastel, soft

## Named references

**Illustrators**: Mike Winkelmann / Beeple

**Products / films**: EVERYDAYS, Manifest Destiny
...
Edgy cultural commentary, NFT-adjacent art brand, music album.

## When NOT to use

friendly SaaS, kids, restrained AI marketing
