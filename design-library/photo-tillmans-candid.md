...
**Camera / lens**: 50mm prime, point-and-shoot 35mm

**Film stock / post-processing**: color negative film, no retouching, slightly faded warm tones, gentle highlight roll-off

**Mood**: intimate, equal, non-hierarchical, observational

**Avoid (negative prompt)**: studio, retouched, posed, professional model, dramatic lighting, glamour
...
Indie fashion, magazine-style lifestyle, anything that needs to read as cool-because-it-doesn't-try. Strong for editorial websites that want to avoid the polished e-commerce look.

## When NOT to use

Luxury, glamour, conversion-focused product pages, B2B.
