...
**Camera / lens**: Leica M6, 35mm lens

**Film stock / post-processing**: Kodak Tri-X 400, full tonal range, fine grain, archival black-and-white

**Mood**: observed, dignified, witness

**Avoid (negative prompt)**: posed, smiling-at-camera, flash, dramatic color, glossy
...
Editorial journalism, NGO marketing, humanitarian campaigns, museum, archival heritage brands.

## When NOT to use

Product e-comm, anything aspirational-consumer.
