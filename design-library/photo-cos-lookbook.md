...
**Camera / lens**: Sony A7R, 50mm or 85mm, f/4

**Film stock / post-processing**: faithful color, slightly cool, retained fabric texture

**Mood**: composed, modern, restrained

**Avoid (negative prompt)**: hard flash, busy backdrop, smile, candid, retouched skin perfection
...
Apparel e-comm, contemporary fashion lookbook, modern minimal hospitality, premium home goods, premium tech apparel.

## When NOT to use

Loud or kinetic brand, fast e-comm with high SKU count.
