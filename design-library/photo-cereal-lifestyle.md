...
**Camera / lens**: Fuji GFX medium format, 50mm equivalent, f/5.6

**Film stock / post-processing**: cool muted color grade, slight blue-gray cast, retained highlight detail

**Mood**: calm, considered, slow

**Avoid (negative prompt)**: warm, saturated, busy, crowd, motion
...
Hospitality, real estate, modernist furniture, Scandi brands, slow-lifestyle apps, premium travel.

## When NOT to use

Tech B2B, fast-paced consumer, anything kinetic.
