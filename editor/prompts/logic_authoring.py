...
5. VERIFY IT ACTUALLY WORKS (see section 7). Bake the composer node, then run the visual QA. Do NOT tell the user it is done until QA returns a pass.

### 7. Verify the effect (visual QA) - MANDATORY before claiming success
