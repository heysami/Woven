...
3. **The picked option's `<palette>`, `<display font>`, `<body font>`, and `<axes>` are immutable through build.** Phase A locks them verbatim. No "Anton" substitution when the user picked Space Grotesk; no "warmer slate" replacement for `#161616`. The user picked; the build ships. **When the pick produces an `art-direction-contract.json` (Phase A.7), that contract's `buildRegister` locks alongside the visual picks** - it is the derived-per-project language the build briefs are phrased in (naming the craft's own model of each thing), and it holds through build exactly as palette/fonts/axes do. It is a prose lane governing brief LANGUAGE, kept separate from the contract's `voice` block (which governs shipped user-facing copy - Step 8).
...
- **bubble-pop-rounded** `[retro-pop identity · inflated rounded logotype · 1965-78 revival]` - one Cooper/ronde-era bubble face as the WHOLE identity type on flat saturated grounds with thick cream keylines; commercial logotype register, not street bubble-graffiti. → [`style-bubble-pop-rounded.md`](./design-library/style-bubble-pop-rounded.md)
...
- **pixel-teletext-mosaic** `[broadcast graphics · 2x3 block-mosaic on a 40x25 grid]` - Ceefax-style teletext service pages: 8 RGB primaries on black, double-height rows, page-number chrome, dither checkerboards; a reading service on a character grid, not arcade sprites or PC-98 anime. → [`aesthetic-pixel-teletext-mosaic.md`](./design-library/aesthetic-pixel-teletext-mosaic.md)
...
**Design-canon expansions (deco / baroque / folk / dada / data-portrait heritage):**
- **art-deco-marquee** `[theatrical luxury · gold-line deco ornament + inline marquee capitals on ebony]` - Art Deco cinema glamour drawn entirely in fine gold linework; the wealth is ornament, not photography (vs luxury-cinematic-dark's photographic darkness). → [`aesthetic-art-deco-marquee.md`](./design-library/aesthetic-art-deco-marquee.md)
- **baroque-gilt-estate** `[heritage formality · gilt scrollwork cartouches + parterre aerials · raster]` - sincere baroque estate grandeur in hedge green and ivory that never breaks character; no modern intrusion (vs neoclassical-remix) and daylit-groomed, not bookish (vs dark-academia). → [`aesthetic-baroque-gilt-estate.md`](./design-library/aesthetic-baroque-gilt-estate.md)
- **folk-geometric-deco** `[regional craft modernism · notched folk type + numbered ornament grammar · raster]` - embroidery and carving motifs rationalized into an angular two-ink type-and-ornament system; rooted in place where constructivism agitates and bauhaus universalizes. → [`aesthetic-folk-geometric-deco.md`](./design-library/aesthetic-folk-geometric-deco.md)
- **dada-ephemera-collage** `[printed-scrap assemblage · tickets, stubs and stamps as UI components · raster]` - Merz-style ephemera collage where every element carries its own paper substrate; a full material world, not just type mixing (vs style-ransom-glyph-mix). → [`aesthetic-dada-ephemera-collage.md`](./design-library/aesthetic-dada-ephemera-collage.md)
- **dubois-data-portraits** `[hand-painted statistics · flat gouache spirals and wrapped bars on aged board · raster]` - archival statistical graphics as moral argument, human hand visible in every mark; painterly and rhetorical where swiss-modernist is mechanical and dashboards are neutral. → [`aesthetic-dubois-data-portraits.md`](./design-library/aesthetic-dubois-data-portraits.md)
- **greiman-digital-new-wave** `[bitmap-hybrid collage · photos pixel-dissolving into fragments across angled duotone type · raster]` - first-digital-hand New Wave where the pixel is the brush and dissolution is compositional; image-led digital (vs weingart's letterpress type deconstruction, risograph's uniform grain). → [`aesthetic-greiman-digital-new-wave.md`](./design-library/aesthetic-greiman-digital-new-wave.md)
- **mondo-tech-utopian** `[cyberdelic editorial · one hot orange+cyan ink pair page-wide, slanted slab display · raster]` - early-Wired techno-utopian spreads with duotone halftone hardware and greedy glossary margins; sincere flat-ink optimism where acid-design is dark ironic chrome. → [`aesthetic-mondo-tech-utopian.md`](./design-library/aesthetic-mondo-tech-utopian.md)
- **catalog-sleeve-minimalism** `[numbered-identity restraint · engraved diagram hero + color-code cipher strip on matte black]` - Factory-Records catalog-system identity, wide-tracked mono, chroma confined to one code strip; diagram-led dark ceremony (vs monochrome-tech-editorial's archival photos, industrial-catalog's light-ground spec sheets). → [`aesthetic-catalog-sleeve-minimalism.md`](./design-library/aesthetic-catalog-sleeve-minimalism.md)
- **celestial-atlas-chart** `[scientific-romantic cartography · magnitude-scaled star plots on coordinate-gridded navy]` - antique engraved star-atlas conventions as interface, ember-red targets and instrument-reading metadata; the drawn map of space, never photoreal space (vs cosmic-horizon) and drafted, not moody (vs dark-academia). → [`aesthetic-celestial-atlas-chart.md`](./design-library/aesthetic-celestial-atlas-chart.md)

**Retro-tech hardware / console / broadcast UI (most need raster):**
- **lcars-elbow-console** `[sci-fi interface · curved elbow frames as layout]` - Starship wall-panel UI: pastel pill segments and numeric code labels on void black, flat backlit plastic; pristine and calm where cassette-futurism is worn and atompunk is googie. → [`aesthetic-lcars-elbow-console.md`](./design-library/aesthetic-lcars-elbow-console.md)
- **win95-system-chrome** `[90s desktop chrome · 1px bevel wizard furniture · needs-raster (dithered banner art + icons)]` - C0C0C0 dialog-gray as a full sincere system with Back/Next/Cancel ritual; the material grammar itself, unlike shell-desktop-os-metaphor's layout shell or vaporwave's ironic quotation. → [`aesthetic-win95-system-chrome.md`](./design-library/aesthetic-win95-system-chrome.md)
- **cdrom-multimedia-console** `[mid-90s multimedia · machined panels with inset media wells · needs-raster (steel bevel chrome + painterly inserts)]` - Myst/Encarta rendered-hardware console: riveted brushed steel framing glowing painterly scenes; industrial cursor-era fantasy, not iOS-6 leather gloss or a lone aluminum surface. → [`aesthetic-cdrom-multimedia-console.md`](./design-library/aesthetic-cdrom-multimedia-console.md)
- **camcorder-osd-viewfinder** `[capture overlay · corner brackets + edge-pinned readouts]` - Live viewfinder OSD: segmented LCD type, REC amber, zebra stripes, empty center; the camera's crisp framing grammar, not VHS tape degradation. → [`aesthetic-camcorder-osd-viewfinder.md`](./design-library/aesthetic-camcorder-osd-viewfinder.md)
- **mecha-crisis-hud** `[90s anime command center · countdown-as-hero + hazard stripes · needs-raster (mecha line-art schematic)]` - NERV-style emergency wall: phosphor orange/acid green/alert red signal semantics with kanji alert headlines; a military bunker interior, not cyberpunk street neon or single-hue CRT phosphor. → [`aesthetic-mecha-crisis-hud.md`](./design-library/aesthetic-mecha-crisis-hud.md)
- **arcade-marquee-neon** `[showfloor signage · chrome-bevel + airbrush script over neon tube outlines · needs-raster (marquee logotypes)]` - Backlit cabinet-marquee glamour on starfield vinyl black; sincere commercial hype, not vaporwave pastel irony or in-game pixel-arcade sprites. → [`aesthetic-arcade-marquee-neon.md`](./design-library/aesthetic-arcade-marquee-neon.md)
- **synthwave-outrun** `[retrofuturist hero composition · grid-sun-horizon with chrome-extruded title · needs-raster (chrome 3D logotype)]` - Heroic night-drive synthwave: cyan wireframe grid to a striped sun on magenta dusk; earnest and kinetic where vaporwave is corporate-melancholic and y2k-futurism is chrome-blob optimism. → [`aesthetic-synthwave-outrun.md`](./design-library/aesthetic-synthwave-outrun.md)
- **ansi-bbs-artscene** `[terminal subculture · CP437 block-shading illustration + box-drawing chrome]` - Dial-up BBS maximalism: 16-color ANSI art logos, numbered menu doors, hotkey brackets, blink fields; an illustrated world plus interface grammar, not a monochrome ascii texture or modern terminal-on-web minimalism. → [`aesthetic-ansi-bbs-artscene.md`](./design-library/aesthetic-ansi-bbs-artscene.md)
- **analog-studio-hardware** `[mid-century console skeuomorphism · ivory VU meters with needle ballistics]` - Recording-desk material world: engraved caps, walnut and bakelite, red reserved for peak; a specific electromechanical era, not generic skeuomorph gloss or cassette-futurism's beige CRT age. → [`aesthetic-analog-studio-hardware.md`](./design-library/aesthetic-analog-studio-hardware.md)
- **rhythm-machine-panel** `[early-80s instrument hardware · color-banked 16-step row + seven-segment tempo]` - TR-808 silkscreen panel: matte black chassis, rubber step keys with LED dots, total physical legibility; the LED-and-silkscreen generation after analog-studio-hardware's wood-and-ivory, nothing like beige cassette-futurism. → [`aesthetic-rhythm-machine-panel.md`](./design-library/aesthetic-rhythm-machine-panel.md)
- **darkroom-safelight** `[photochemical craft · one amber light on physical materials · needs-raster (material tooth + monochrome prints)]` - Darkroom under safelight: enamel trays, fiber paper, grease-pencil lettering, LCD timer digits, monochrome by physics; reflected lamplight on matte materials, not emissive CRT-phosphor glow. → [`aesthetic-darkroom-safelight.md`](./design-library/aesthetic-darkroom-safelight.md)
- **data-sublime-datamatics** `[data-art minimalism · barcode fields + numeric rasters in absolute 1-bit]` - Ikeda-style data sublime: pure black/white, sine lattices, data glyphs AS the surface, inversion as the only state change; an art register past legibility, not dense-mono product UI or a code-grid background texture. → [`aesthetic-data-sublime-datamatics.md`](./design-library/aesthetic-data-sublime-datamatics.md)

**Japanese street / broadcast / craft vernacular:**
- **city-pop-airbrush** `[music-sleeve · chrome-script-over-airbrush-sunset · needs-raster]` - Sincere 80s Japanese city-pop sleeve: peach-to-lilac airbrush seascape, mirror-chrome script logotype, palm silhouettes; the unironic original that vaporwave remixes. → [`aesthetic-city-pop-airbrush.md`](./design-library/aesthetic-city-pop-airbrush.md)
- **jp-variety-telop** `[broadcast-typography · multi-stroke-katakana-bursts · needs-raster]` - Japanese variety-show telop captions: per-word emotion colors, rotated baselines, burst bubbles, speed lines, holo foil; the anarchic opposite of token-disciplined jp-recruit-pop. → [`aesthetic-jp-variety-telop.md`](./design-library/aesthetic-jp-variety-telop.md)
- **gyaru-magazine-glitter** `[street-fashion-press · cutout-clusters-with-price-leader-lines · needs-raster]` - 2000s gyaru magazine density: hot pink + gold glitter on white, overlapping model cutouts, ¥ callouts, purikura scrawl; commerce-driven clutter, not considered maximalism. → [`aesthetic-gyaru-magazine-glitter.md`](./design-library/aesthetic-gyaru-magazine-glitter.md)
- **gothic-lolita-lace-print** `[fashion-mook-print · engraved-lace-borders-and-ribbon-banners · needs-raster]` - Romantic engraved register: black and blood-red lace on cream, Didone over etched ribbons, pen-and-ink garment plates; dressmaker's parlor, not dark-academia's library. → [`aesthetic-gothic-lolita-lace-print.md`](./design-library/aesthetic-gothic-lolita-lace-print.md)
- **menhera-yami-kawaii** `[character-subculture · bandaged-plush-plus-medical-crosses · needs-raster]` - Sick-cute inversion: candy pink and mint with syringes, safety pins, stitched mascots; kawaii that acknowledges hurt, unlike explicitly sunny positivity-kawaii. → [`aesthetic-menhera-yami-kawaii.md`](./design-library/aesthetic-menhera-yami-kawaii.md)
- **showa-emergency-broadsheet** `[civil-defense-print · sumi-brush-headline-on-warning-stripes · needs-raster]` - Kaiju-era emergency broadsheet: brush calligraphy over newsreel grain, red/white stripes, bureaucratic stamps, romaji echo lines; loud institutional sibling of the quiet poster canon. → [`aesthetic-showa-emergency-broadsheet.md`](./design-library/aesthetic-showa-emergency-broadsheet.md)
- **shibuya-kei-obi-sleeve** `[record-packaging · vertical-type-columns-as-texture]` - Obi-band typographic sleeve: one spot ink on cream, dense vertical credits as texture, catalog numbers and barcodes as ornament; zero photography where japanese-poster-layout is photo-dominant. → [`aesthetic-shibuya-kei-obi-sleeve.md`](./design-library/aesthetic-shibuya-kei-obi-sleeve.md)
- **angura-silkscreen-poster** `[theatre-poster · clashing-spot-inks-plus-halftone-faces · needs-raster]` - 60s underground theatre silkscreen: vermilion/jade/cadmium clash, dry-brush lettering, sunbursts, ticket-stub borders; the whole cultural register that USES the silkscreen material. → [`aesthetic-angura-silkscreen-poster.md`](./design-library/aesthetic-angura-silkscreen-poster.md)
- **tokyo-signboard-canyon** `[urban-vernacular · different-sign-medium-per-stacked-row · needs-raster]` - Rain-slicked signboard alley: neon script, backlit acrylic, brush kanji stacked per floor, wet reflections; documentary izakaya warmth, not cyberpunk's single sci-fi register. → [`aesthetic-tokyo-signboard-canyon.md`](./design-library/aesthetic-tokyo-signboard-canyon.md)
- **night-market-brush-vernacular** `[stall-signage · marker-on-kraft-price-cards · needs-raster]` - Night-market stall graphics: rough brush lettering in saffron/white/red on ink navy, lantern glow, woodcut stamps; handmade stall cards versus signboard-canyon's fabricated electric signs. → [`aesthetic-night-market-brush-vernacular.md`](./design-library/aesthetic-night-market-brush-vernacular.md)
- **japandi-craft-minimal** `[craft-interior · material-swatches-plus-hanko-stamp · needs-raster]` - Japanese craft-material warm minimalism: washi, plaster, weathered wood, hammered bronze, vertical CJK accents, one vermilion stamp, generous ma; material-first gallery calm, not western SaaS warmth. → [`aesthetic-japandi-craft-minimal.md`](./design-library/aesthetic-japandi-craft-minimal.md)

**Global street / pop vernacular:**
- **dancehall-fluoro-card** `[music-street-print · outline caps + brush-slash + date table on fluo card · needs-raster]` - soundsystem poster screened in heavy black on fluorescent yellow/pink card with a tabular date/venue skeleton; cheap-ink texture-first, unlike monochrome-pop-poster's clean modern flood. → [`aesthetic-dancehall-fluoro-card.md`](./design-library/aesthetic-dancehall-fluoro-card.md)
- **highlife-tropical-print** `[music-heritage-print · brush-script over painted portrait, halftone on cream · needs-raster]` - mid-century tropical record sleeve with outlined script, mango/palm/hibiscus inks and travel-poster art; printed-1962 warmth, unlike pastel-pop-fmcg's flat modern shelf. → [`aesthetic-highlife-tropical-print.md`](./design-library/aesthetic-highlife-tropical-print.md)
- **afrofuturist-goldline** `[cultural-cosmology-dark · concentric glyph wheels engraved gold-on-void · needs-raster]` - afrofuturist symbol-system instrument panel in antique gold hairlines on warm black with sand/metal materials; drawn cosmology, no photography, unlike defi-cosmic's nebula-photo crypto-mysticism. → [`aesthetic-afrofuturist-goldline.md`](./design-library/aesthetic-afrofuturist-goldline.md)
- **punk-fanzine-fluoro** `[counterculture-zine · fluoro tape-labels slapped over b/w halftone portraits · needs-raster]` - paste-up scene magazine with dry-brush masthead, misregistered pink/green spot inks on newsprint; photo-anchored collage, unlike zine-type-wall's type-only density. → [`aesthetic-punk-fanzine-fluoro.md`](./design-library/aesthetic-punk-fanzine-fluoro.md)
- **barbiecore-gloss** `[toy-brand-program · one licensed pink + white script logotype + gloss plastic · needs-raster]` - single-hue doll-brand flood with starbursts and blister-pack sheen; joyful script-and-gloss monochrome, unlike monochrome-pop-poster's sporty condensed-caps hype. → [`aesthetic-barbiecore-gloss.md`](./design-library/aesthetic-barbiecore-gloss.md)
- **deviantart-oc-scrawl** `[fandom-amateur-sheet · spike-burst marker lettering + doodles on graph paper · needs-raster]` - scene-era OC reference sheet in toxic purple/lime with stat tables and do-not-steal furniture; deliberately unpolished paper document, unlike y2k-myspace's glitter web chaos. → [`aesthetic-deviantart-oc-scrawl.md`](./design-library/aesthetic-deviantart-oc-scrawl.md)
- **googie-roadside-neon** `[hospitality-signage · neon script + bulb-chase arrows over midnight navy + fabrication linework · needs-raster]` - 50s sign-shop register mixing the lit sign with its working drawing; optimistic commercial neon craft, unlike atompunk's print-era graphics or cyberpunk's sci-fi glow. → [`aesthetic-googie-roadside-neon.md`](./design-library/aesthetic-googie-roadside-neon.md)
- **jet-age-airline-ephemera** `[travel-document · carrier navy/jet red coupons, engraved crests, carbon numerals · needs-raster]` - 60s airline paperwork as UI: tabbed coupons, security-pattern stock, VOID stamps; document artefact, unlike swiss-modernist's poster discipline. → [`aesthetic-jet-age-airline-ephemera.md`](./design-library/aesthetic-jet-age-airline-ephemera.md)
- **spy-dossier-typewriter** `[thriller-case-file · ribbon-ink typewriter caps + crosshair halftones + red CLASSIFIED stamps · needs-raster]` - cold-war manila dossier with surveillance photo grids and field-row data furniture; a full covert-document world, unlike material-photocopy-xerox's surface-only toner filter. → [`aesthetic-spy-dossier-typewriter.md`](./design-library/aesthetic-spy-dossier-typewriter.md)

**Document / signage / retail ephemera systems:**
- **transit-ticket-ephemera** `[travel documents · perforated pass + amber-alert gate board]` - white segmented boarding-pass artefact (perforated stub, QR, mono data) over dark tabular gate rows with one amber alert; the document is the hero, unlike pure data-row dashboards. → [`aesthetic-transit-ticket-ephemera.md`](./design-library/aesthetic-transit-ticket-ephemera.md)
- **transit-wayfinding-signage** `[transit signage · black humanist sans on signal yellow + pictogram tiles]` - airport wayfinding system with inverted pictogram tiles, arrow grammar, and walk-time chips on a saturated yellow field; signage glance-speed where swiss-modernist stays print composition. → [`aesthetic-transit-wayfinding-signage.md`](./design-library/aesthetic-transit-wayfinding-signage.md)
- **football-club-heraldic** `[sports heraldry · crest + arched keylined shirt number · needs-raster]` - navy-and-crest-gold club identity with laurel devices, poly-weave and embroidery textures, and sponsor lockups; daylight tribal ceremony, not luxury-cinematic-dark's spotlit exclusivity. → [`aesthetic-football-club-heraldic.md`](./design-library/aesthetic-football-club-heraldic.md)
- **home-sewing-pattern** `[craft instruction · dashed cut/stitch notation + lettered views · needs-raster]` - vintage pattern-envelope register: drafting-ink fashion flats with pastel fills on manila tissue, red dashed rules with meaning; codified commercial notation where craft-sketchbook is loose doodle. → [`aesthetic-home-sewing-pattern.md`](./design-library/aesthetic-home-sewing-pattern.md)
- **toy-catalogue-primaries** `[retail print · unmixed primary blocks + starburst price splats · needs-raster]` - 80s toy-catalogue spread: chubby rounded white display, product-photo cards with stock codes on red/yellow/blue; earnest cheap print, not neubrutalism's art-directed rawness or pastel-pop's tints. → [`aesthetic-toy-catalogue-primaries.md`](./design-library/aesthetic-toy-catalogue-primaries.md)
- **toy-aisle-window-box** `[toy packaging · gingham-framed cellophane window + scalloped stickers · needs-raster]` - constructed window-box register with diorama shots, contents lists, and shelf-tag badges; packaging construction where cottagecore is only fabric mood, box vs the catalogue's flat page. → [`aesthetic-toy-aisle-window-box.md`](./design-library/aesthetic-toy-aisle-window-box.md)
- **origami-engineering-blueprint** `[engineered fold · sheared parallelograms on crease-grid + gold foil]` - aerospace deployable-structure spec sheet: every component shears to one fold angle on matte white with mono spec codes; the folded thing itself, not cad-blueprint's cyan drafting. → [`aesthetic-origami-engineering-blueprint.md`](./design-library/aesthetic-origami-engineering-blueprint.md)
- **industrial-streetwear-label** `[utility fashion · "QUOTES" grammar + orange zip-tie tags · needs-raster]` - deadpan label streetwear: DIN condensed caps, hazard stripes, LOT/ZONE utility boxes on base white; fashion quoting industry, unlike industrial-catalog's sincere spec sheets. → [`aesthetic-industrial-streetwear-label.md`](./design-library/aesthetic-industrial-streetwear-label.md)
- **tdr-info-noise** `[pop-techno branding · two flat inks on void black + trademark clutter]` - Designers-Republic-style info-noise: magenta/safety-orange, barcodes, crosshairs, faux-JP stamps, condensed techno caps, all rigidly gridded; composed clutter where acid-design melts and y2k-futurism gleams. → [`aesthetic-tdr-info-noise.md`](./design-library/aesthetic-tdr-info-noise.md)
